    ...
    <Card className="shadow-card hover:shadow-elevated transition-all duration-300">
      <CardContent className="p-6">
        ...
        <div className="glass-card p-4 mb-4 rounded-lg bg-gradient-to-r from-primary-light/5 to-accent/5 border border-accent/10">
          <p className="text-sm text-primary-light">O que deseja consultar hoje?</p>
        </div>
          ...
          {suggestionQueries.map((query, index) => (
            <Button
              ...
              className="w-full justify-start px-4 py-3 text-left text-sm rounded-lg border border-gray-200 
                        hover:border-accent hover:bg-gray-50 transition-colors duration-200 h-auto"
            >
        ...
        <div className="mt-6 pt-4 border-t border-gray-100">
          <Link href="/assistant">
            <Button
              className="w-full py-3 bg-accent text-white rounded-lg hover:bg-accent-light shadow-sm 
                       transition-all duration-200 hover:translate-y-[-1px] flex items-center justify-center"
            >
